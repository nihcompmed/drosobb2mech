...
# ───────────────────── JobID → filling method ─────────────────────
ZERO_IDS_250916 = {
    250916001,250916002,250916003,250916004,250916005,250916006,
    250916007,250916008,250916009,250916010,250916011,250916012
}
AVG_IDS_250916 = {
    250916013,250916014,250916015,250916016,250916017,250916018,
    250916019,250916020,250916021,250916022,250916023,250916024
}
RAND_IDS_250916 = {
    250916025,250916026,250916027,250916028,250916029,250916030,
    250916031,250916032,250916033,250916034,250916035,250916036
}

def filling_method_for(job_id: int) -> str:
    if job_id in ZERO_IDS_250916:
        return "zero"
    if job_id in AVG_IDS_250916:
        return "avg"
    if job_id in RAND_IDS_250916:
        return "rand"
...
# ───────────────────── Batch/sharding ─────────────────────
ALL_JOB_IDS = sorted(
    ZERO_IDS_250916 | AVG_IDS_250916 | RAND_IDS_250916
)
