...
def main():
    ...
    ap.add_argument("--vae_class",   required=True, type=str, help="e.g., Step2_trainVAE_penalizeJacdec_27g_ver3_lamjacschedule:VAE")
    ap.add_argument("--vae_ckpt",    required=True, type=str)
